...
(function ($) {
  ...
  $(".color-1").on("click", function () {
    $("#add_class").remove();
    $("head").append(
      '<link rel="stylesheet" href="frontend/css/color-1.css" id="add_class">'
    );
  });
  $(".color-2").on("click", function () {
    $("#add_class").remove();
    $("head").append(
      '<link rel="stylesheet" href="frontend/css/color-2.css" id="add_class">'
    );
  });
  $(".color-3").on("click", function () {
    $("#add_class").remove();
    $("head").append(
      '<link rel="stylesheet" href="frontend/css/color-3.css" id="add_class">'
    );
  });
  $(".color-4").on("click", function () {
    $("#add_class").remove();
    $("head").append(
      '<link rel="stylesheet" href="frontend/css/color-4.css" id="add_class">'
    );
  });
  $(".color-5").on("click", function () {
    $("#add_class").remove();
    $("head").append(
      '<link rel="stylesheet" href="frontend/css/color-5.css" id="add_class">'
    );
  });
  $(".color-6").on("click", function () {
    $("#add_class").remove();
    $("head").append(
      '<link rel="stylesheet" href="frontend/css/color-6.css" id="add_class">'
    );
  });
  $(".color-7").on("click", function () {
    $("#add_class").remove();
    $("head").append(
      '<link rel="stylesheet" href="frontend/css/color-7.css" id="add_class">'
    );
  });
  $(".color-8").on("click", function () {
    $("#add_class").remove();
    $("head").append(
      '<link rel="stylesheet" href="frontend/css/color-8.css" id="add_class">'
    );
  });
  $(".color-9").on("click", function () {
    $("#add_class").remove();
    $("head").append(
      '<link rel="stylesheet" href="frontend/css/color-9.css" id="add_class">'
    );
  });
  ...
  $(".rtl").on("click", function () {
    $("head").append(
      '<link rel="stylesheet" href="frontend/css/rtl.css" id="add_rtl">'
    );
  });
  ...
  $(".dark").on("click", function () {
    $("head").append(
      '<link rel="stylesheet" href="frontend/css/dark.css" id="add_dark">'
    );
  });
  ...
  $(".box-1").on("click", function () {
    $("head").append(
      '<link rel="stylesheet" href="frontend/css/box-1.css" id="add_box">'
    );
  });
  ...
  $(".bg-1").on("click", function () {
    ...
    $("head").append('<link rel="stylesheet" class="bg" href="frontend/css/bg-1.css" id="add_bg">');
  ...
  $(".bg-2").on("click", function () {
    ...
    $("head").append('<link rel="stylesheet" class="bg" href="frontend/css/bg-2.css" id="add_bg">');
  ...
  $(".bg-3").on("click", function () {
    ...
    $("head").append('<link rel="stylesheet" class="bg" href="frontend/css/bg-3.css" id="add_bg">');
  ...
  $(".bg-4").on("click", function () {
    ...
    $("head").append('<link rel="stylesheet" class="bg" href="frontend/css/bg-4.css" id="add_bg">');
  ...
  $(".bg-5").on("click", function () {
    ...
    $("head").append('<link rel="stylesheet" class="bg" href="frontend/css/bg-5.css" id="add_bg">');
