            ...
            <div class="row mb-minus-24">
                <div class="col-12" data-aos="fade-up" data-aos-duration="1000">
                    <div class="rx-banner text-center rx-banner-effects">
                        <p><img src="frontend/img/banner/left-shape.svg" alt="banner-left-shape" class="svg-img left-side">Luxury Suites<img src="frontend/img/banner/right-shape.svg" alt="banner-right-shape" class="svg-img right-side"></p>
                        ...
                        <div class="rooms-box-back">
                            ...
                            <div class="content-wrap">
                                ...
                                <div class="inner-back-side">
                                    ...
                                    <div class="last-contact">
                                        <a href="room-details.html" class="inner-button">Book Now</a>
                                        <a href="room-details.html" class="inner-button"><i class="ri-arrow-right-up-line"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
