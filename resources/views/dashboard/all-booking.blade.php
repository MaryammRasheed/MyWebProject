            ...
            <div class="content">
                <div class="row">
                    ...
                    <div class="col-sm-8 col-9 text-right m-b-20">
                        <a href="{{ url('/add-booking')}}" class="btn btn btn-primary btn-rounded float-right"><i class="fas fa-plus"></i> Add Booking</a>
                    </div>
                </div>
				<div class="row">
					<div class="col-md-12">
							...
							<table class="table table-striped custom-table">
								...
								<tbody>
									<tr>
										...
										<td>2nd Feb 2019</td>
										<td>3nd Feb 2019</td>
                                        <td><a href="mailto:daniyal@gmail.com">daniyal@gmail.com</a></td>
										...
										<td class="text-right">
											<div class="dropdown dropdown-action">
												...
												<div class="dropdown-menu dropdown-menu-right">
													<a class="dropdown-item" href="{{ url('/edit-booking')}}"><i class="fas fa-pencil-alt m-r-5"></i> Edit</a>
									...
									<tr>
										...
										<td>2nd Feb 2019</td>
										<td>3nd Feb 2019</td>
                                        <td><a href="mailto:junaid@gmail.com">junaid@gmail.com</a></td>					
                                        					<td>987654321 </td>
